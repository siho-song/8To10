...
INSERT INTO SCHEDULE (member_id, title, description, start_date, end_date, created_at, created_by)
VALUES
    (1, 'First Schedule', 'Description of the first schedule.', '2024-01-01', '2024-01-07', NOW(), 'system'),
    (2, 'Second Schedule', 'Description of the second schedule.', '2024-02-01', '2024-02-07', NOW(), 'system'),
    (3, 'Third Schedule', 'Description of the third schedule.', '2024-03-01', '2024-03-07', NOW(), 'system');

-- N_SCHEDULE 테이블에 데이터 삽입
INSERT INTO N_SCHEDULE (category_unit, buffer_time, frequency, schedule_id)
VALUES
    ('PAGE', '01:00:00', 'weekly', 1),
    ('CHAPTER', '00:30:00', 'monthly', 2),
    ('LECTURE', '02:00:00', 'weekly', 3);

-- F_SCHEDULE 테이블에 데이터 삽입
INSERT INTO F_SCHEDULE (start_time, duration, frequency, schedule_id)
VALUES
    ('09:00:00', 60, 'daily', 1),
    ('10:00:00', 90, 'weekly', 2),
    ('11:00:00', 120, 'monthly', 3);

-- V_SCHEDULE 테이블에 데이터 삽입
INSERT INTO V_SCHEDULE (start_time, end_time, schedule_id, day, complete_status, updated_at, updated_by)
VALUES
    ('09:00:00', '10:00:00', 1, 'Mon', false, NOW(), 'system'),
    ('10:00:00', '11:00:00', 2, 'Tue', false, NOW(), 'system'),
    ('11:00:00', '12:00:00', 3, 'Wed', false, NOW(), 'system'),
    ('12:00:00', '13:00:00', 1, 'Thu', false, NOW(), 'system'),
    ('13:00:00', '14:00:00', 2, 'Fri', false, NOW(), 'system');

-- N_SCHEDULE_DETAIL 테이블에 데이터 삽입
INSERT INTO N_SCHEDULE_DETAIL (n_schedule_id, start_time, end_time, complete_status, day, detail_description, updated_by, updated_at)
VALUES
    (1, '09:00:00', '10:00:00', false, 'Mon', 'Detail of the first N_SCHEDULE.', 'system', NOW()),
    (1, '10:00:00', '11:00:00', false, 'Tue', 'Detail of the first N_SCHEDULE.', 'system', NOW()),
    (1, '11:00:00', '12:00:00', false, 'Wed', 'Detail of the first N_SCHEDULE.', 'system', NOW()),
    (1, '12:00:00', '13:00:00', false, 'Thu', 'Detail of the first N_SCHEDULE.', 'system', NOW()),
    (1, '13:00:00', '14:00:00', false, 'Fri', 'Detail of the first N_SCHEDULE.', 'system', NOW()),
    (2, '09:00:00', '10:00:00', false, 'Mon', 'Detail of the second N_SCHEDULE.', 'system', NOW()),
    (2, '10:00:00', '11:00:00', false, 'Tue', 'Detail of the second N_SCHEDULE.', 'system', NOW()),
    (2, '11:00:00', '12:00:00', false, 'Wed', 'Detail of the second N_SCHEDULE.', 'system', NOW()),
    (2, '12:00:00', '13:00:00', false, 'Thu', 'Detail of the second N_SCHEDULE.', 'system', NOW()),
    (2, '13:00:00', '14:00:00', false, 'Fri', 'Detail of the second N_SCHEDULE.', 'system', NOW());

-- F_SCHEDULE_DETAIL 테이블에 데이터 삽입
INSERT INTO F_SCHEDULE_DETAIL (f_schedule_id, day, complete_status, detail_description, updated_by, updated_at)
VALUES
...
-- N_RANGE 테이블에 데이터 삽입
INSERT INTO N_RANGE (n_schedule_id, start_range, end_range)
VALUES
    (1, 1, 50),
    (2, 51, 100),
    (3, 1, 50);
...
-- N_VALUE 테이블에 데이터 삽입
INSERT INTO N_VALUE (n_schedule_id, value)
VALUES
    (1, 25),
    (2, 75),
    (3, 25);
