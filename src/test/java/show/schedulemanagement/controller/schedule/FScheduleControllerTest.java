...
class FScheduleControllerTest {
    ...
    @Test
    @DisplayName("고정일정 생성 - weekly, biweekly, daily")
    void add_weekly() throws Exception {
        ...
        events.add(getFixDetailAddDto(LocalTime.now(), LocalTime.of(2, 0), "biweekly",
        ...
        log.debug("addFSchedule Test request dto : {} ", fixAddDtoJson);
