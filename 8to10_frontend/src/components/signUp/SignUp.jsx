...
import { validateNickname, validateEmail, validatePhone, validatePassword } from './validateSignUp';
import PublicHeader from "@/components/PublicHeader.jsx"; // 유효성 검사 함수 가져오기
