package com.eighttoten.presentation.board;
...
import com.eighttoten.entity.community.SearchCond;
import com.eighttoten.entity.community.SortCondition;
...
class PostEntityControllerTest {
    ...
    void boardAddTest() throws Exception {
        PostSaveRequest dto = new PostSaveRequest("게시판 테스트용", "테스트......................");
