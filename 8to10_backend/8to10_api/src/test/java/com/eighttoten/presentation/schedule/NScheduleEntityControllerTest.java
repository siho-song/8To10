...
public class NScheduleEntityControllerTest {
    ...
    private NScheduleSaveRequest nScheduleSaveRequest;
    private NScheduleUpdateRequest nScheduleUpdateRequest;
    ...
    public void init() {
        ...
        nScheduleSaveRequest = NScheduleSaveRequest.builder()
                .title("Test ScheduleEntity")
        ...
        nScheduleUpdateRequest = NScheduleUpdateRequest.builder()
                .id(4L)
                .title("수정된 제목")
    ...
    public void add() throws Exception {
        mockMvc.perform(post("/schedule/normal")
                        ...
                        .content(objectMapper.writeValueAsString(nScheduleSaveRequest)))
    ...
    public void update() throws Exception {
        mockMvc.perform(put("/schedule/normal")
                        .header("Authorization","Bearer " + token) // JWT 쿠키 추가
                        .contentType(APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(nScheduleUpdateRequest)))
    ...
    public void updateDetail() throws Exception {
        NDetailUpdateRequest nDetailUpdateRequest = NDetailUpdateRequest.builder()
                .id(1L)
        ...
        mockMvc.perform(put("/schedule/normal/detail")
                ...
                .contentType(APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(nDetailUpdateRequest))
        ).andExpect(status().isNoContent());
    }
    ...
    public void updateProgress() throws Exception {
        ProgressUpdatesRequest progressUpdatesRequest = ProgressUpdatesRequest.builder()
                .date(LocalDate.of(2024, 5, 1))
                .progressUpdateRequests(List.of(ProgressUpdateRequest.builder()
                        .scheduleDetailId(1L)
                        .completeStatus(true)
                        .achievedAmount(10)
                        .build())
        ...
        String dto = objectMapper.writeValueAsString(progressUpdatesRequest);
