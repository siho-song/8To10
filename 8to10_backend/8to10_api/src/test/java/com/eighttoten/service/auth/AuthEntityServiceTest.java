...
import com.eighttoten.entity.auth.AuthEntity;
import com.eighttoten.entity.auth.AuthRedisRepository;
...
class AuthEntityServiceTest {
    ...
    void getRenewalAccessToken() {
        ...
        AuthEntity authEntity = AuthEntity.of("normal@example.com", null);
        when(authRedisRepository.findByRefreshToken(any())).thenReturn(Optional.of(authEntity));
