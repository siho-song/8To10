...
(
    ...
    `member_id`   bigint       NOT NULL,
    `title`       varchar(255) NOT NULL,
    `common_description` TEXT NOT NULL DEFAULT '',
...
VALUES
    ...
    ('normal3@example.com', 'token_for_member_3', NOW(), 'ADMIN', NOW(), 'ADMIN'),
    ('normal4@example.com', 'token_for_member_4', NOW(), 'ADMIN', NOW(), 'ADMIN'),
    ('admin@example.com', 'token_for_member_5', NOW(), 'ADMIN', NOW(), 'ADMIN'),
    ('faithful@example.com', 'token_for_member_6', NOW(), 'ADMIN', NOW(), 'ADMIN');

-- BOARD 테이블에 데이터 삽입
INSERT INTO BOARD (member_id, title, contents, created_at, updated_at, total_like, total_scrap)
VALUES
    (1, 'First PostEntity Post 1', 'This is the contents of the first postEntity post for memberEntity 1.', NOW(), NOW(), 5, 2),
    (1, 'First PostEntity Post 2', 'This is the contents of the second postEntity post for memberEntity 1.', NOW(), NOW(), 3, 1),
    (1, 'First PostEntity Post 3', 'This is the contents of the third postEntity post for memberEntity 1.', NOW(), NOW(), 4, 0),
    (1, 'First PostEntity Post 4', 'This is the contents of the fourth postEntity post for memberEntity 1.', NOW(), NOW(), 2, 3),
    (1, 'First PostEntity Post 5', 'This is the contents of the fifth postEntity post for memberEntity 1.', NOW(), NOW(), 6, 1),
    (1, 'First PostEntity Post 6', 'This is the contents of the sixth postEntity post for memberEntity 1.', NOW(), NOW(), 1, 0),
    (1, 'First PostEntity Post 7', 'This is the contents of the seventh postEntity post for memberEntity 1.', NOW(), NOW(), 0, 0),
    (1, 'First PostEntity Post 8', 'This is the contents of the eighth postEntity post for memberEntity 1.', NOW(), NOW(), 7, 2),
    (1, 'First PostEntity Post 9', 'This is the contents of the ninth postEntity post for memberEntity 1.', NOW(), NOW(), 2, 1),
    (1, 'First PostEntity Post 10', 'This is the contents of the tenth postEntity post for memberEntity 1.', NOW(), NOW(), 5, 3),
    (1, 'First PostEntity Post 11', 'This is the contents of the eleventh postEntity post for memberEntity 1.', NOW(), NOW(), 4, 2),
    (1, 'First PostEntity Post 12', 'This is the contents of the twelfth postEntity post for memberEntity 1.', NOW(), NOW(), 3, 0),
    (1, 'First PostEntity Post 13', 'This is the contents of the thirteenth postEntity post for memberEntity 1.', NOW(), NOW(), 6, 1),
    (1, 'First PostEntity Post 14', 'This is the contents of the fourteenth postEntity post for memberEntity 1.', NOW(), NOW(), 2, 2),
    (1, 'First PostEntity Post 15', 'This is the contents of the fifteenth postEntity post for memberEntity 1.', NOW(), NOW(), 1, 0),

    (2, 'Second PostEntity Post 1', 'This is the contents of the first postEntity post for memberEntity 2.', NOW(), NOW(), 5, 2),
    (2, 'Second PostEntity Post 2', 'This is the contents of the second postEntity post for memberEntity 2.', NOW(), NOW(), 3, 1),
    (2, 'Second PostEntity Post 3', 'This is the contents of the third postEntity post for memberEntity 2.', NOW(), NOW(), 4, 0),
    (2, 'Second PostEntity Post 4', 'This is the contents of the fourth postEntity post for memberEntity 2.', NOW(), NOW(), 2, 3),
    (2, 'Second PostEntity Post 5', 'This is the contents of the fifth postEntity post for memberEntity 2.', NOW(), NOW(), 6, 1),
    (2, 'Second PostEntity Post 6', 'This is the contents of the sixth postEntity post for memberEntity 2.', NOW(), NOW(), 1, 0),
    (2, 'Second PostEntity Post 7', 'This is the contents of the seventh postEntity post for memberEntity 2.', NOW(), NOW(), 0, 0),
    (2, 'Second PostEntity Post 8', 'This is the contents of the eighth postEntity post for memberEntity 2.', NOW(), NOW(), 7, 2),
    (2, 'Second PostEntity Post 9', 'This is the contents of the ninth postEntity post for memberEntity 2.', NOW(), NOW(), 2, 1),
    (2, 'Second PostEntity Post 10', 'This is the contents of the tenth postEntity post for memberEntity 2.', NOW(), NOW(), 5, 3),
    (2, 'Second PostEntity Post 11', 'This is the contents of the eleventh postEntity post for memberEntity 2.', NOW(), NOW(), 4, 2),
    (2, 'Second PostEntity Post 12', 'This is the contents of the twelfth postEntity post for memberEntity 2.', NOW(), NOW(), 3, 0),
    (2, 'Second PostEntity Post 13', 'This is the contents of the thirteenth postEntity post for memberEntity 2.', NOW(), NOW(), 6, 1),
    (2, 'Second PostEntity Post 14', 'This is the contents of the fourteenth postEntity post for memberEntity 2.', NOW(), NOW(), 2, 2),
    (2, 'Second PostEntity Post 15', 'This is the contents of the fifteenth postEntity post for memberEntity 2.', NOW(), NOW(), 1, 0),

    (3, 'Third PostEntity Post 1', 'This is the contents of the first postEntity post for memberEntity 3.', NOW(), NOW(), 5, 2),
    (3, 'Third PostEntity Post 2', 'This is the contents of the second postEntity post for memberEntity 3.', NOW(), NOW(), 3, 1),
    (3, 'Third PostEntity Post 3', 'This is the contents of the third postEntity post for memberEntity 3.', NOW(), NOW(), 4, 0),
    (3, 'Third PostEntity Post 4', 'This is the contents of the fourth postEntity post for memberEntity 3.', NOW(), NOW(), 2, 3),
    (3, 'Third PostEntity Post 5', 'This is the contents of the fifth postEntity post for memberEntity 3.', NOW(), NOW(), 6, 1),
    (3, 'Third PostEntity Post 6', 'This is the contents of the sixth postEntity post for memberEntity 3.', NOW(), NOW(), 1, 0),
    (3, 'Third PostEntity Post 7', 'This is the contents of the seventh postEntity post for memberEntity 3.', NOW(), NOW(), 0, 0),
    (3, 'Third PostEntity Post 8', 'This is the contents of the eighth postEntity post for memberEntity 3.', NOW(), NOW(), 7, 2),
    (3, 'Third PostEntity Post 9', 'This is the contents of the ninth postEntity post for memberEntity 3.', NOW(), NOW(), 2, 1),
    (3, 'Third PostEntity Post 10', 'This is the contents of the tenth postEntity post for memberEntity 3.', NOW(), NOW(), 5, 3),
    (3, 'Third PostEntity Post 11', 'This is the contents of the eleventh postEntity post for memberEntity 3.', NOW(), NOW(), 4, 2),
    (3, 'Third PostEntity Post 12', 'This is the contents of the twelfth postEntity post for memberEntity 3.', NOW(), NOW(), 3, 0),
    (3, 'Third PostEntity Post 13', 'This is the contents of the thirteenth postEntity post for memberEntity 3.', NOW(), NOW(), 6, 1),
    (3, 'Third PostEntity Post 14', 'This is the contents of the fourteenth postEntity post for memberEntity 3.', NOW(), NOW(), 2, 2),
    (3, 'Third PostEntity Post 15', 'This is the contents of the fifteenth postEntity post for memberEntity 3.', NOW(), NOW(), 1, 0);
--
-- REPLY 테이블에 데이터 삽입
INSERT INTO REPLY (member_id, board_id, parent_id, contents, total_like, created_at, updated_at)
VALUES
...
VALUES
    (1, 'fixed schedule1', 'Description of the first scheduleEntity.', '2024-01-01 00:00:00', '2024-01-07 00:00:00', NOW(), 'normal@example.com', 'F', NOW(), 'normal@example.com'),
    (2, 'fixed schedule2', 'Description of the second scheduleEntity.', '2024-02-01 00:00:00', '2024-02-14 00:00:00', NOW(), 'normal2@example.com', 'F', NOW(), 'normal2@example.com'),
    (1, 'fixed schedule3', 'Description of the third scheduleEntity.', '2024-03-01 00:00:00', '2024-03-21 00:00:00', NOW(), 'normal@example.com', 'F', NOW(), 'normal@example.com'),
    (1, 'normal schedule1', 'Description of the fourth scheduleEntity.', '2024-05-01 00:00:00', '2024-05-07 00:00:00', NOW(), 'normal@example.com', 'N', NOW(), 'normal@example.com'),
    (1, 'normal schedule3', 'Description of the fourth schedule3.', '2024-05-01 00:00:00', '2024-05-07 00:00:00', NOW(), 'normal@example.com', 'N', NOW(), 'normal@example.com'),
    (2, 'normal schedule2', 'Description of the fifth scheduleEntity.', '2024-06-01 00:00:00', '2024-06-14 00:00:00', NOW(), 'normal2@example.com', 'N', NOW(), 'normal2@example.com'),
    (1, 'normal schedule3', 'Description of the sixth scheduleEntity.', '2024-07-01 00:00:00', '2024-07-22 00:00:00', NOW(), 'normal@example.com', 'N', NOW(), 'normal@example.com'),
    (1, 'variable Schedule1', 'Description of the seventh scheduleEntity.', '2024-08-01 00:00:00', '2024-08-01 00:00:00', NOW(), 'normal@example.com', 'V', NOW(), 'normal@example.com'),
    (1, 'variable Schedule2', 'Description of the eighth scheduleEntity.', '2024-09-01 00:00:00', '2024-09-01 00:00:00', NOW(), 'normal@example.com', 'V', NOW(), 'normal@example.com'),
    (2, 'variable Schedule3', 'Description of the ninth scheduleEntity.', '2024-10-01 00:00:00', '2024-10-01 00:00:00', NOW(), 'normal2@example.com', 'V', NOW(), 'normal2@example.com');
...
VALUES
    ...
    (5, '2024-05-01 13:00:00', '2024-05-05 14:00:00', false, 'Detail of the first N_SCHEDULE.','normal@example.com', '2024-04-30 09:00:00', 'normal@example.com','2024-04-30 09:00:00',20,0),
    (5, '2024-05-02 13:00:00', '2024-05-05 14:00:00', false, 'Detail of the first N_SCHEDULE.','normal@example.com', '2024-04-30 09:00:00', 'normal@example.com','2024-04-30 09:00:00',20,0),
    (5, '2024-05-03 13:00:00', '2024-05-05 14:00:00', false, 'Detail of the first N_SCHEDULE.','normal@example.com', '2024-04-30 09:00:00', 'normal@example.com','2024-04-30 09:00:00',20,0),
    (5, '2024-05-04 13:00:00', '2024-05-05 14:00:00', false, 'Detail of the first N_SCHEDULE.','normal@example.com', '2024-04-30 09:00:00', 'normal@example.com','2024-04-30 09:00:00',20,0),
    (5, '2024-05-05 13:00:00', '2024-05-05 14:00:00', false, 'Detail of the first N_SCHEDULE.','normal@example.com', '2024-04-30 09:00:00', 'normal@example.com','2024-04-30 09:00:00',20,0),
    (6, '2024-06-01 09:00:00', '2024-06-01 10:00:00', false, 'Detail of the second N_SCHEDULE.','normal2@example.com', '2024-04-30 09:00:00', 'normal2@example.com','2024-04-30 09:00:00',40,0),
    (6, '2024-06-02 10:00:00', '2024-06-02 11:00:00', false, 'Detail of the second N_SCHEDULE.','normal2@example.com', '2024-04-30 09:00:00', 'normal2@example.com','2024-04-30 09:00:00',40,0),
    (6, '2024-06-03 11:00:00', '2024-06-03 12:00:00', false, 'Detail of the second N_SCHEDULE.','normal2@example.com', '2024-04-30 09:00:00', 'normal2@example.com','2024-04-30 09:00:00',40,0),
    (6, '2024-06-04 12:00:00', '2024-06-04 13:00:00', false, 'Detail of the second N_SCHEDULE.','normal2@example.com', '2024-04-30 09:00:00', 'normal2@example.com','2024-04-30 09:00:00',40,0),
    (6, '2024-06-05 13:00:00', '2024-06-05 14:00:00', false, 'Detail of the second N_SCHEDULE.','normal2@example.com', '2024-04-30 09:00:00', 'normal2@example.com','2024-04-30 09:00:00',40,0),
    (7, '2024-07-01 09:00:00', '2024-07-01 10:00:00', false, 'Detail of the third N_SCHEDULE.','normal@example.com', '2024-04-30 09:00:00', 'normal@example.com','2024-04-30 09:00:00',60,0),
    (7, '2024-07-02 10:00:00', '2024-07-02 11:00:00', false, 'Detail of the third N_SCHEDULE.','normal@example.com', '2024-04-30 09:00:00', 'normal@example.com','2024-04-30 09:00:00',60,0),
    (7, '2024-07-03 11:00:00', '2024-07-03 12:00:00', false, 'Detail of the third N_SCHEDULE.','normal@example.com', '2024-04-30 09:00:00', 'normal@example.com','2024-04-30 09:00:00',60,0),
    (7, '2024-07-04 12:00:00', '2024-07-04 13:00:00', false, 'Detail of the third N_SCHEDULE.','normal@example.com', '2024-04-30 09:00:00', 'normal@example.com','2024-04-30 09:00:00',60,0),
    (7, '2024-07-05 13:00:00', '2024-07-05 14:00:00', false, 'Detail of the third N_SCHEDULE.','normal@example.com', '2024-04-30 09:00:00', 'normal@example.com','2024-04-30 09:00:00',60,0);
...
INSERT INTO NOTIFICATION (member_id, message, is_read, target_url, related_entity_id, notification_type, created_at,
                          updated_at)
VALUES (1, 'You have a new message!', false, '/postEntity/1', 2, 'REPLY_ADD', NOW(), NOW()),
       (2, 'Your scheduleEntity is updated.', false, NULL, NULL, 'TODO_UPDATE', NOW(), NOW()),
