...
public class NScheduleControllerTest {
    ...
    private NScheduleSaveRequestRequest nScheduleSaveRequest;
    ...
    public void init() {
        ...
        nScheduleSaveRequest = NScheduleSaveRequestRequest.builder()
                .title("Test Schedule")
    ...
    public void updateDetail() throws Exception {
        NormalDetailUpdateRequest normalDetailUpdateRequest = NormalDetailUpdateRequest.builder()
                .id(1L)
        ...
        mockMvc.perform(put("/schedule/normal/detail")
                ...
                .contentType(APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(normalDetailUpdateRequest))
        ).andExpect(status().isNoContent());
    }
